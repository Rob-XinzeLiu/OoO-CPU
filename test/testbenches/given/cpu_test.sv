...
// TODO:    Add your own debugging framework. Basic printing of data structures
...
`endif
    ...
    initial begin
        // You can use these two commands to generate dumpfiles for waveform viewing (with tools like VaporView)
        // TODO: - Modify these commands as necessary to dump the variables you want.
        //       - There are also SV expressions that allow to save dump data at a set time in the testbench code, which could help
        //          eliminate the first couple cycles of a program that are working well.
        //       - Dumpfiles are big! Programs like alexnet generate a multiple GB vcd file, which slows down your testing and
        //          might not even finish due to storage limits. Utilize the expressions system verilog supports!
        // $dumpfile("cpu.vcd");
        // $dumpvars(0);
    ...
    task print_custom_data;
        ...
        //         verisimpleV.committed_insts[i].PC == 32'h0268) begin
