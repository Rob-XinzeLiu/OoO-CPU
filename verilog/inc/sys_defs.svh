...
// the project 2 processor has a massive boost in performance just from having no mem latency
// see if you can beat it's CPI in the final project even with a 100ns latency!
...
typedef enum logic [3:0] {
    ...
    HALTED_ON_WFI       = 4'he, // 'Wait For Interrupt'. In 472, signifies the end of computation
