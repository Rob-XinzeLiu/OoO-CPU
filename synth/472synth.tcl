...
# Welcome to the EECS 472 design compiler synthesis script!
...
set search_path [list "./" "../" "../[getenv INC]" "/usr/caen/misc/class/eecs470/lib/synopsys/"]
...
# where the magic happens. Don't change this. You're not allowed to ;)
