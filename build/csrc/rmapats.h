...
extern "C" {
#endif
void  rmaPropagate0_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate0_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate0_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate1_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate1_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate2_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate2_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate3_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate3_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate6_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate6_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate7_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate7_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate8_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate8_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate9_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate9_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate10_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate10_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate13_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate13_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_p_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_dcache_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_f_dcache_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate14_r_dcache_simv_daidir (UB  * pcode);
void  rmaPropagate14_wn_dcache_simv_daidir (UB  * pcode, scalar  val);
