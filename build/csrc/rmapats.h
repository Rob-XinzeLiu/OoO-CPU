...
extern "C" {
#endif
void  rmaPropagate4_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate9_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate9_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate10_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate10_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate11_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate11_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate14_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate14_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate15_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate15_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate16_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate16_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate17_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate17_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate18_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate18_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate19_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate20_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate20_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate20_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate21_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate21_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate29_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate29_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate29_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate30_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate30_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate30_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate31_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate38_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate38_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate42_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate42_t0_cpu_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate42_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate43_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate43_t0_cpu_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate43_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate44_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate44_t0_cpu_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate44_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate45_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate45_t0_cpu_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate45_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_p_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_cpu_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate46_f_cpu_simv_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate46_r_cpu_simv_daidir (UB  * pcode);
void  rmaPropagate46_t0_cpu_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate46_wn_cpu_simv_daidir (UB  * pcode, scalar  val);
