...
#ifndef __VCS_IMPORT_DPI_STUB_decode_inst
#define __VCS_IMPORT_DPI_STUB_decode_inst
__attribute__((weak)) SV_STRING decode_inst(/* INPUT */int A_1)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static SV_STRING (*_vcs_dpi_fp_)(/* INPUT */int A_1) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (SV_STRING (*)(int A_1)) dlsym(RTLD_NEXT, "decode_inst");
    ...
    if (_vcs_dpi_fp_) {
        ...
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "decode_inst");
        return 0;
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_decode_inst */
